...
with open(output_sh_path, 'w') as sh_file, open(historico_path, 'a') as historico_file:
    ...
    for i, sequencia in enumerate(sequencias_escolhidas, start=1):
        ...
        sh_file.write(f"timeout 70s ./vanitysearch -stop -t 0 -gpu -gpuId 0,1,2,3,4,5,6,7 -o {out_file_path} --keyspace {range_completo} 1BY8GQbnueYofwSuFAT3USAhGjPrkxDdW9 &\n")
        sh_file.write("sleep 70\n")
